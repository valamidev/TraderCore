...
const strategies = [
...

  {
    ...
    config: {
      ...
      stopLossLimit: [0.9, 0.95, "float", 3]
    }
  },

  {
    ...
    config: {
      buy_signal_Length: [6, 12, "int"],
      sell_signal_Length: [6, 12, "int"],
      rsi_low: [0, 15, "int"],
      rsi_high: [85, 100, "int"],
      stopLossLimit: [0.95, 0.97, "float", 3]
    }
  },

  {
    ...
    config: {
      ...
      stopLossLimit: [0.9, 0.97, "float", 3]
    }
  },
...

  {
    ...
    config: {
      ...
      stopLossLimit: [0.9, 0.93, "float", 3]
    }
  },
