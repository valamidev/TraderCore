...
const WF_SMA = require("../utils/indicators/WF_SMA");
...
class Strategy {
  ...
  update_buffer(candle) {
    ...
    // Williams Fractal SMA
    this.wf_sma.update(this.ohcl4.result);
    this.BUF.wf_sma.push(this.wf_sma.result);
  ...
  async BUY() {
    ...
    this.advice = "BUY";
    this.last_action_step = this.step;
    ...
    try {
      ...
      if (this.step > this.minimum_history) {
        ...
        if (
          ...
          this.last_action_step + 21 < this.step*/
        ) {
          /* console.log(
            "Buy rsi: ",
